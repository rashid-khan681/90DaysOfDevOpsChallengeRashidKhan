...
**Notes:**
* **What is a GitHub-hosted runner?** - **Answer:** It is a temporary virtual machine provided by GitHub that spins up just to run your job and gets destroyed immediately after.
