...
**Action:** I ran `docker image history nginx` to inspect the internal architecture of a Docker image.
...
**Action:** I deployed a detached Nginx container (`docker run -d -p 8080:80`) and executed live triage:
